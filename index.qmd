...
The purpose of this document is to plot from any common R package data-set; here we have choosen the IRIS data-set used extensively throughout the course material to date. We will use IRIS to view Petal variance by species.
